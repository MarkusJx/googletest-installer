...
function install() {
    if (process.platform === "linux") {
        ...
        spawnSync('sudo cp googletest/build/lib/libgtest.a /usr/lib');
        spawnSync('sudo cp googletest/build/lib/libgtest_main.a /usr/lib');
        ...
        console.log("\nInstalling googletest...");
        spawnSync('sudo cp googletest/build/lib/*.a /opt/local/lib');
